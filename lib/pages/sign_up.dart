...
class _SignUpState extends State<SignUp> {
            ...
            child: Padding(
              ...
              child: (Column(
                ...
                children: [
                  ...
                  Wrap(
                    children: const [Text("Sign Up",style: TextStyle(color: Colors.black38, fontSize: 30),)],
                  ),
                  const SizedBox(
                    height: 20.0,
                  ),
  ...
  registerUser() async {
    String authKey = CometChatAuthConstants.authKey;//Replace with the auth key of app
